...
type User struct {
	gorm.Model
	UserAccount  string  `json:"user_account" gorm:"size:256" binding:"required,min=4"`
	UserName     string  `json:"user_name,omitempty" gorm:"size:256"`
	AvatarUrl    string  `json:"avatar_url,omitempty" gorm:"size:1024"`
	Gender       bool    `json:"gender"`
	UserPassword string  `json:"user_password,omitempty" gorm:"size:256" binding:"required,min=8"`
